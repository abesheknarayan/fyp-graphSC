...
class EdgeListEncodedGraph:
    ...
    def sourceSort(self):
        sortObject = bitonicSortPlainText.BitonicSortPlainText(self.graphList, 0, 2, 1, -1)
    ...
    def destinationSort(self):
        sortObject = bitonicSortPlainText.BitonicSortPlainText(self.graphList, 1, 2, 1, 1)
        sortObject.startSort()
